...
public class PainelEditarProduto extends JPanel {
	...
	private void salvarAlteracoes() {
		...
		try {
			...
			if (atualizado) {
				JOptionPane.showMessageDialog(this, "Produto atualizado com sucesso.", "Atualização realizada",
						JOptionPane.INFORMATION_MESSAGE);

				voltar();

			} else {
				JOptionPane.showMessageDialog(this, "Não foi possível atualizar o produto.", "Erro",
						JOptionPane.ERROR_MESSAGE);
			}

		} catch (NumberFormatException erro) {
			JOptionPane.showMessageDialog(this, "Digite valores numéricos válidos.", "Erro de conversão",
					JOptionPane.ERROR_MESSAGE);
		}
	}
