...
--
-- Host: localhost    Database: controle_estoque_db
-- ------------------------------------------------------
...
INSERT INTO `categorias` VALUES (1,'Informática','Produtos de informática e acessórios',1),(2,'Escritório','Materiais de escritório',1),(3,'Limpeza','Produtos de limpeza',1);
...
INSERT INTO `clientes` VALUES (1,'Maria Silva','000.000.000-00','(85) 98888-1111','maria@email.com','Fortaleza',1,'2026-08-01 15:09:10'),(2,'João Souza LS','111.111.111-11','(85) 98888-2222','joao@email.com','Maracanaú',1,'2026-08-01 15:09:10'),(3,'Teste Usuário LS','123456789-12','85996968596','teste@teste.com','Fortaleza',0,'2026-08-01 15:14:02');
...
INSERT INTO `fornecedores` VALUES (1,'Distribuidora Alfa','00.000.000/0001-00','(85) 99999-0001','contato@alfa.com','Fortaleza',1,'2026-08-01 14:00:22'),(2,'Comercial Beta','11.111.111/0001-11','(85) 99999-0002','contato@beta.com','Maracanaú',1,'2026-08-01 14:00:22');
...
CREATE TABLE `usuarios` (
  ...
  `perfil` enum('ADMINISTRADOR','OPERADOR') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'OPERADOR',
  `ativo` tinyint(1) NOT NULL DEFAULT '1',
